...
let final = data.books.forEach((char) => {
    ...
    a.href = char.website;
    a.innerText = "Go to Website"

    let span = document.createElement("span");
    span.classList.add("span-text");
    span.innerText = `Author: ${char.author}`;
    
    let span1 = document.createElement("span");
    span1.classList.add("span-text");
    span1.innerText = `Published ${char.published}`;

    let span2 = document.createElement("span");
    span2.classList.add("span-text");
    span2.innerText = `Publisher : ${char.publisher}`;

    let span3 = document.createElement("span");
    span3.classList.add("span-text");
    span3.innerText = `No. of pages: ${char.pages}`;
