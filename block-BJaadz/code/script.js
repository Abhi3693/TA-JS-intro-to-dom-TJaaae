...
allHrsArray.forEach((val)=> val.style.borderStyle = "dashed");
...
let box4 = document.body.children[0].children[1].children[3].style.border = '1px solid black'  //document.querySelector(".four")
